...
#'
#' This is a function from which calculates tree heights given initial age and height
#' 
#' @param height_t1 This is the tree height at the starting year
#' @param t1 This is a number indicating the starting year
#' @param t2 This is a number indicating the ending year
#'
#' @return
#' @export
#'
